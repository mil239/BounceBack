...
export default function ExerciseScreen() {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style={styles.subtitle}>Select a joint and enter your age.</Text>

            {/* Age Input */}
            <TextInput
                style={styles.input}
                placeholder="Your age (e.g. 45)"
...
const styles = StyleSheet.create({
    ...
    input:          { backgroundColor: '#fff', borderRadius: 10, padding: 14, fontSize: 16, elevation: 2, marginBottom: 16 },
